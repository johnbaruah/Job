...
if (isset($_POST['final2'])) {
      ...
      $updatefinal2 = $mysqli->query("update user_details set status = 1 where f_id_sign = '$id' limit 1");
...
<div class="col-md-12">
  <div class="prgrs">
<div class="progress1">
  <div class="prgrs-br progress-bar-animated prgrs-r-strpd" role="progressbar" style="width: 73%"></div>
</div>
...
<tr>
  ...
  <tr>
    <td colspan="4" class="dclrsn"><p class="text-justify">
<input type="checkbox" id="declare" name="declare" value="declare" required>
  <span >I do hereby declare that all the particulars given by me in this form are true to the best of my knowledge and belief and if any mistake / misinformation, detected at any stage in future, will result in the cancellation of my candidature. I shall abide by all the terms and conditions therein.</span></p></td>
</tr>
<tr>
...
<div class="text-center p-3">
  <div class="btn btn-primary" type="submit"   onclick="location.href='modify_form_data.php'">Modify Application Form?</div>
  <button  class="btn btn-danger" name="final2">Finel Submit</button>
</div>
</form>
</div>
